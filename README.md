# ARDrone
parrot旗下ARDrone2，上海交通大举的高分无人飞行器智能感知技术竞赛以下两回合

# 寻迹自主飞行
无人机自主航迹控制	运行控制软件，从绿色标识处启动自主飞行模式，到达蓝色标识处自动停止。

# Follow Me! 二维码自动跟随
基于无人机视觉的目标搜索、目标识别和跟踪	基于所编写的控制软件利用无人机携带的摄像头，使无人机紧密地跟随选手。选手按照赛道指示，牵引无人机顺利到达终点。

# Package droneTest
获取图像，对图像二值化和轮廓识别，对识别的点进行最小二乘法直线拟合，得到偏角和距离中心的位置
