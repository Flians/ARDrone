...
struct ControlCommand
{
	...
	{
        this->roll = roll; //y fu
        this->pitch = pitch; //x fu
        this->yaw = yaw; //angular fu
        this->gaz = gaz; //z zheng
	}
...
public:
    ...
    ros::ServiceClient getPath_cli;
    droneTest::Num_srv num_srv;
	...
	bool lastL1Pressed;
	bool lastR1Pressed;
    void path_tracking(const droneTest::Num info);
    ...
    void sendFlattrim();
    void startTracking();
    double pid_update(struct pid *pid, double input);
};
